...
@HystrixCommand(fallbackMethod = "defaultGetItemName")
public String findItemName(Long itemId) {
	
	System.out.println("*********** inside circuit breaker method @@@@@@@@@@@@");
/*	  itemInfoRepository.findByItemId(itemId);
	     return "item #"+itemId+" find successfully";*/
	throw new RuntimeException("Simulating downstream system failure");
	 }

private String defaultGetItemName(Long itemId, Throwable t) {
